    ...
    if($_REQUEST['rollback']){
        ...
        if($rollback != "" ){
            try{
                ...
                //componer el segundo insert sql (omitimos el código para provocar el error)
                $insert_rally_2 = 'INSERT INTO rally (codRally, nombre, pais, fecha) VALUES ("Rally ' .$codigo_2. '", "País rally ' .$codigo_2. '", "'.date("Y-m-d").'")';
                //prepara la sentencia para su ejecución
